...
curl -Lo /etc/systemd/system/sing-box.service https://raw.githubusercontent.com/Xiaotuzipiaopiao/s5li/main/sing-box.service
...
wget https://raw.githubusercontent.com/Xiaotuzipiaopiao/s5li/main/config.json
